  ...
  inline fmSensor1: TfmSensor
    ...
    inherited PanelALL: TPanel [0]
      ...
      inherited PanelSensorControl: TPanel
        ...
        ExplicitWidth = 334
        ExplicitHeight = 454
        inherited grbAnomalyDetectorSensor: TGroupBox [0]
          Width = 328
          Height = 448
          ParentBackground = False
          ParentColor = False
        ...
        inherited grbElectroOpticalSensor: TGroupBox [1]
          Width = 328
          Height = 448
          ParentBackground = False
          ParentColor = False
        ...
        inherited grbESMSensorControl: TGroupBox [2]
          Width = 328
          Height = 448
          ParentBackground = False
          ParentColor = False
        ...
        inherited grbIFFInterrogatorControl: TGroupBox [3]
          Width = 328
          Height = 448
          ParentBackground = False
          ParentColor = False
        ...
        inherited grbIFFTransponderControl: TGroupBox [4]
          Width = 328
          Height = 448
          ParentBackground = False
          ParentColor = False
        ...
        inherited grbSearchRadarControl: TGroupBox [5]
          Width = 328
          Height = 448
          ParentBackground = False
          ParentColor = False
