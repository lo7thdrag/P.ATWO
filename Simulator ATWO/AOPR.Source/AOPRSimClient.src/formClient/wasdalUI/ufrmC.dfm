  ...
  inline fmCounterMeasure1: TfmCounterMeasure
    ...
    inherited PanelALL: TPanel
      ...
      inherited PanelCounterMeasure: TPanel
        ...
        ExplicitWidth = 361
        ExplicitHeight = 391
        inherited grpAirBubble: TGroupBox [0]
          Width = 361
          Height = 391
          ParentBackground = False
          ParentColor = False
        ...
        inherited grbRadarNoiseJammer: TGroupBox [2]
          Width = 361
          Height = 391
          ParentBackground = False
          ParentColor = False
        ...
        inherited grbFloatingDecoy: TGroupBox [4]
          Width = 361
          Height = 391
          ParentBackground = False
          ParentColor = False
        ...
        inherited grbAcousticDecoy: TGroupBox [6]
          Width = 361
          Height = 391
          ParentBackground = False
          ParentColor = False
    ...
    inherited PanelCounterMeasureChoice: TPanel [1]
      Width = 361
      Color = 4012086
      ParentColor = False
      ExplicitWidth = 361
    ...
    inherited PanelCounterMeasureSpace: TPanel [2]
      Width = 361
      ExplicitWidth = 361
    end
