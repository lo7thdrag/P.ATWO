...
//    frxUsrdtstSumm: TfrxUserDataSet;
    ...
    CategoryPanelStatusWas: TCategoryPanel;
    CategoryViewTacticalWas2: TCategoryPanel;
    btnPlatStatus: TRzBmpButton;
    imgsep1: TImage;
    btnLogStatus: TRzBmpButton;
    img1: TImage;
    btnTransStatus: TRzBmpButton;
    btnEnviStatus: TRzBmpButton;
    img2: TImage;
    img3: TImage;
    btnEventSum: TRzBmpButton;
    btnTacDisplay: TRzBmpButton;
    pnlSideBar: TPanel;
...
//    lblSoundVelocityProfile.Caption       := IntToStr(Sound_Velocity_Type);
    ...
    case Sea_State of
      ...
      begin
        ...
        imgSeaState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\2_Sea.png');
      end;
      2 :
      begin
        lblSeaStatDesc.Caption           := 'Smooth (wavelets)';
        imgSeaState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\3_Sea.png');
      end;
      3 :
      begin
        lblSeaStatDesc.Caption           := 'Slight';
        imgSeaState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\4_Sea.png');
      end;
      4 :
      begin
        lblSeaStatDesc.Caption           := 'Moderate';
        imgSeaState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\5_Sea.png');
      end;
      5 :
      begin
        lblSeaStatDesc.Caption           := 'Rough';
        imgSeaState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\6_Sea.png');
      end;
      6 :
      begin
        lblSeaStatDesc.Caption           := 'Very rough';
        imgSeaState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\7_Sea.png');
      end;
      7 :
      begin
        lblSeaStatDesc.Caption           := 'High';
        imgSeaState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\8_Sea.png');
      end;
      8 :
      begin
    ...
    case Rain_Rate of
      ...
      begin
        ...
        imgRainState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\1_Rain.png');
      ...
      begin
        ...
        imgRainState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\2_Rain.png');
        imgSunDisplay.Visible := True;
      ...
      begin
        ...
        imgRainState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\3_Rain.png');
    ...
    case Cloud_Attenuation of
      ...
      begin
        ...
        imgCloudState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\1_Cloud.png');
        Fogstate:= 'FOG1';
        if Rain_Rate = 0 then
        begin
          pnlEnvironmentDisplay.Color := $00FFFDDD;
      ...
      begin
        ...
        imgCloudState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\2_Cloud.png');
        Fogstate:= 'FOG2';
        if Rain_Rate = 0 then
        begin
      ...
      begin
        ...
        imgCloudState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\3_Cloud.png');
        Fogstate:= 'FOG2';
        if Rain_Rate = 0 then
        begin
      ...
      begin
        ...
        imgCloudState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\MiniPic\4_Cloud.png');
        Fogstate:= 'FOG3';
        if Rain_Rate = 0 then
        begin
...
//    lblSeaState.Caption                   := IntToStr(Sea_State);
    ...
    //lOAD FOR DISPLAY
    imgRainStateDisplay.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\' + Fogstate + '\cloud\' + (Rain_Rate + 1).ToString + '.png');
    imgSeaStateDisplay.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\' + Fogstate + '\wave\' + (Sea_State + 1).ToString + '.png');
    imgRainDisplay.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\' + Fogstate + '\Rain\' + (Rain_Rate + 1).ToString + '.png');
    imgSunDisplay.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\' + Fogstate + '\Sun\' + '1.png');
  end;
...
var
  ...
  env : TEnvi;
begin
   TryStrToFloat(edtdaytimevis.Text, dayVis);
   edtdaytimevis.Text := ' ';
   with rec do
   begin
     rec.Envi_Chance := 3;
...
var
  ...
  env : TEnvi;
begin
   TryStrToFloat(edtNighVisual.Text, nightVis);
   edtNighVisual.Text := ' ';
   with rec do
   begin
     rec.Envi_Chance := 4;
...
begin
  ...
  if TryStrToFloat(edtNighvisual.Text, ValueData) and
  ...
  if TryStrToFloat(edtDaytimeInfra.Text, ValueData) and
  ...
  if TryStrToFloat(edtNighInfra.Text, ValueData) and
  ...
  //---------------set envi rain rate--------------------//
  if TryStrToFloat(edtRainRate.Text, ValueData) and
  ...
  if TryStrToFloat(edtCloud.Text, ValueData) and
  ...
  if TryStrToFloat(edtAtmosphereRefac.Text, ValueData) and
...
begin
  ...
  //---------------set envi sea state--------------------//
  if TryStrToInt(edtSea.Text, ValueInt) and
...
//          node,SecondToTimeString(Value));
  ...
  if not ContainsText(simMgrClient.ConsoleName, 'Wasdal') then pnlSideBar.Width := 302
    ...
    imgBgState.Picture.LoadFromFile(vGameDataSetting.DataPath + 'Image Interface\Tote\State\Small.png');
  end;
end;
...
begin
  ...
  pnlPlatCounterMeasure.Height := h - 50;
...
begin
  edtCloud.Text := IntToStr(trbCloud.Position);
end;

procedure TfrmToteDisplay.trbAttenRainRateChange(sender: TObject);
begin
  edtRainRate.Text := IntToStr(trbRainRate.Position);
end;
...
begin
  edtSea.Text := IntToStr(trbSea.Position);
end;
...
var
  value : Integer;
begin
  if not TryStrToInt(edtCloud.Text, value) then
    Exit;

  if value > trbCloud.Max then
    value := trbCloud.Max;

  trbCloud.Position := value;
end;
...
var
  value : Integer;
begin
  if not TryStrToInt(edtRainRate.Text, value) then
    Exit;

  if value > trbRainRate.Max then
    value := trbRainRate.Max;

  trbRainRate.Position := value;
end;
...
var
  value : Integer;
begin
  if not TryStrToInt(edtSea.Text, value) then
    Exit;

  if value > trbSea.Max then
    value := trbSea.Max;

  trbSea.Position := value;
end;
...
procedure TfrmToteDisplay.Panel85Click(Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      trbRainRate.Position := Rain_Rate;
      trbCloud.Position := Cloud_Attenuation;
      ...
      trbSea.SetTick(Sea_State);
      edtSea.Text := IntToStr(Sea_State);
      trbSea.Position := Sea_State;
      ...
      edtRainRate.Text := IntToStr(Rain_Rate);
      trbRainRate.SetTick(Rain_Rate);

      edtCloud.Text := IntToStr(Cloud_Attenuation);
      trbCloud.SetTick(Cloud_Attenuation);
...
//    if PanelTag = 0 then
//    begin
//      pnlTabExport.Color := RGB(54, 78, 85);
//      pnlExport.BringToFront;
//      pnlTabExport.Tag := 1;
//      pnlTabImport.Tag := 0;
//      pnlTabImport.Color := RGB(33, 49, 53);
//    end;
//  end;
//
...
//    if PanelTag = 0 then
//    begin
//      pnlTabImport.Color := RGB(54, 78, 85);
//      pnlImport.BringToFront;
//      pnlTabImport.Tag := 1;
//      pnlTabExport.Tag := 0;
//      pnlTabExport.Color := RGB(33, 49, 53);
//    end;
//  end;
end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabDraft.Color := RGB(54, 78, 85);
      pnlContentDraft.BringToFront;
      pnlTabDraft.Tag := 1;
      pnlTabReceived.Tag := 0;
      pnlTabReceived.Color := RGB(33, 49, 53);
      pnlTabSent.Tag := 0;
      pnlTabSent.Color := RGB(33, 49, 53);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabReceived.Color := RGB(54, 78, 85);
      pnlContentReceived.BringToFront;
      pnlTabReceived.Tag := 1;
      pnlTabDraft.Tag := 0;
      pnlTabDraft.Color := RGB(33, 49, 53);
      pnlTabSent.Tag := 0;
      pnlTabSent.Color := RGB(33, 49, 53);
    end;
  end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabInjection.Color := RGB(191, 107, 84);
      pnlInjection.BringToFront;
      pnlTabInjection.Tag := 1;
      pnlTabVolume.Tag := 0;
      pnlTabVolume.Color := RGB(155, 42, 2);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabVolume.Color := RGB(191, 107, 84);
      pnlVolume.BringToFront;
      pnlTabVolume.Tag := 1;
      pnlTabInjection.Tag := 0;
      pnlTabInjection.Color := RGB(155, 42, 2);
    end;
  end;
end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabExternal.Color := RGB(191, 107, 84);
      pnlExternal.BringToFront;
      pnlTabExternal.Tag := 1;
      pnlTabInternal.Tag := 0;
      pnlTabInternal.Color := RGB(155, 42, 2);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabInternal.Color := RGB(191, 107, 84);
      pnlInternal.BringToFront;
      pnlTabInternal.Tag := 1;
      pnlTabExternal.Tag := 0;
      pnlTabExternal.Color := RGB(155, 42, 2);
    end;
  end;
end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabAboveWater.Color := RGB(191, 107, 84);
      pnlAboveWater.BringToFront;
      pnlTabAboveWater.Tag := 1;
      pnlTabSurfaceAndSub.Tag := 0;
      pnlTabSurfaceAndSub.Color := RGB(155, 42, 2);
      pnlTabBoundaries.Tag := 0;
      pnlTabBoundaries.Color := RGB(155, 42, 2);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabBoundaries.Color := RGB(191, 107, 84);
...
//    pnlNearestBases.Height := 80;
  ...
  begin
    pnlLogisticBottom.Height := 0;
    lblMoreLogisticCalculation.Caption := 'More >>';

//    pnlListPlatform.Height := 856;
    pnlLogisticPlatform.Height := 200;
    pnlStatusTransfer.Height := 184;
    pnlNearestPlatform.Height := 242;
//    pnlNearestBases.Height := 245;
...
begin
  case LastButton of
    1:
    begin
      lblPlatformOp.Font.Color := $00777777;
      lblPlatformCub.Font.Color := $00777777;
    end;
    2:
    begin
      lblLogisticOp.Font.Color := $00777777;
      lblLogisticCub.Font.Color := $00777777;
    end;
    3:
    begin
      lblTransportOp.Font.Color := $00777777;
      lblTransportCub.Font.Color := $00777777;
    end;
    4:
    begin
      lblEnviOp.Font.Color := $00777777;
      lblEnviCub.Font.Color := $00777777;
    end;
    5:
    begin
      lblEventOp.Font.Color := $00777777;
    end;
    6:
    begin
      lblEmitterCub.Font.Color := $00777777;
    end;
    7:
    begin
      lblCubicle.Font.Color := $00777777;
    end;
    8:
    begin
      lblEnviControl.Font.Color := $00777777;
    end;
    9:
    begin
      lblView.Font.Color := $00777777;
    end;
  end;
end;
