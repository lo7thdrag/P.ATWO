...
//  PageControl1.TabIndex := 0;
  pnlTabAll.Color := RGB(191, 107, 84);
  ...
  pnlTabGeneral.Tag := 0;
  pnlTabNone.Tag := 0;
  pnlTabAir.Color := RGB(155, 42, 2);
  pnlTabSurface.Color := RGB(155, 42, 2);
  pnlTabSubsurface.Color := RGB(155, 42, 2);
  pnlTabLand.Color := RGB(155, 42, 2);
  pnlTabGeneral.Color := RGB(155, 42, 2);
  pnlTabNone.Color := RGB(155, 42, 2);
end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabAll.Color := RGB(191, 107, 84);         //muda
      pnlContentAll.BringToFront;
      pnlTabAll.Tag := 1;
      pnlTabAir.Tag := 0;
      pnlTabSurface.Tag := 0;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabAir.Color := RGB(191, 107, 84);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabSurface.Color := RGB(191, 107, 84);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabSubsurface.Color := RGB(191, 107, 84);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabLand.Color := RGB(191, 107, 84);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabGeneral.Color := RGB(191, 107, 84);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabNone.Color := RGB(191, 107, 84);
