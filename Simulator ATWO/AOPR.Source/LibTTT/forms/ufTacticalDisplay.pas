...
//            StatusBar1.Canvas.Brush.Color := clMoneyGreen;
            StatusBar1.Canvas.Brush.Color := StringToColor('$002F2C2B');
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabTrackTable.Color := RGB(191, 107, 84);
      pnlTrackTable.BringToFront;
      pnlTabTrackTable.Tag := 1;
      pnlTabTrackControl.Tag := 0;
      pnlTabTrackControl.Color := RGB(155, 42, 2);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabTrackControl.Color := RGB(191, 107, 84);
      pnlTrackControl.BringToFront;
      pnlTabTrackControl.Tag := 1;
      pnlTabTrackTable.Tag := 0;
      pnlTabTrackTable.Color := RGB(155, 42, 2);
    end;
  end;
end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabHook.Color := RGB(191, 107, 84);
      pnlContentHook.BringToFront;
      pnlTabHook.Tag := 1;
      pnlTabDetails.Tag := 0;
      pnlTabDetection.Tag := 0;
      pnlTabIFF.Tag := 0;
      pnlTabDetails.Color := RGB(155, 42, 2);
      pnlTabDetection.Color := RGB(155, 42, 2);
      pnlTabIFF.Color := RGB(155, 42, 2);
    end;
  end
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabDetails.Color := RGB(191, 107, 84);
      pnlContentDetails.BringToFront;
      pnlTabDetails.Tag := 1;
      pnlTabHook.Tag := 0;
      pnlTabDetection.Tag := 0;
      pnlTabIFF.Tag := 0;
      pnlTabHook.Color := RGB(155, 42, 2);
      pnlTabDetection.Color := RGB(155, 42, 2);
      pnlTabIFF.Color := RGB(155, 42, 2);
    end;
  end
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabDetection.Color := RGB(191, 107, 84);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabIFF.Color := RGB(191, 107, 84);
...
begin
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabOwnShip.Color := RGB(191, 107, 84);
      ...
      pnlTabPlatformGuidance.Color := RGB(155, 42, 2);
      pnlTabCounterMeasure.Color := RGB(155, 42, 2);
      pnlTabWeapon.Color := RGB(155, 42, 2);
      pnlTabSensor.Color := RGB(155, 42, 2);
      pnlTabEMCON.Color := RGB(155, 42, 2);
      pnlTabFireControl.Color := RGB(155, 42, 2);
    end;
  end
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabPlatformGuidance.Color := RGB(191, 107, 84);
      ...
      imgEMCON.Tag := 0;
      imgFireControl.Tag := 0;
      pnlTabOwnShip.Color := RGB(155, 42, 2);
      pnlTabCounterMeasure.Color := RGB(155, 42, 2);
      pnlTabWeapon.Color := RGB(155, 42, 2);
      pnlTabSensor.Color := RGB(155, 42, 2);
      pnlTabEMCON.Color := RGB(155, 42, 2);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabCounterMeasure.Color := RGB(191, 107, 84);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabWeapon.Color := RGB(191, 107, 84);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabSensor.Color := RGB(191, 107, 84);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabEMCON.Color := RGB(191, 107, 84);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabFireControl.Color := RGB(191, 107, 84);
...
begin
  ...
  begin
    ...
    begin
      ...
      pnlTabPosition.Color := RGB(155, 42, 2);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabPosition.Color := RGB(191, 107, 84);
...
//  StatusBar1.Color := clMoneyGreen;
  StatusBar1.Color := StringToColor('$002F2C2B');
