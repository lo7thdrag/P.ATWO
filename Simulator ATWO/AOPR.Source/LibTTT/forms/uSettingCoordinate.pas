...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabCoordinateSystem.Color := RGB(191, 107, 84);
      pnlContentCoordinateSystem.BringToFront;
      pnlTabCoordinateSystem.Tag := 1;
      pnlTabTrackSymbols.Tag := 0;
      pnlTabTrackLabels.Tag := 0;
      pnlTabOther.Tag := 0;
      pnlTabTrackSymbols.Color := RGB(155, 42, 2);
      pnlTabTrackLabels.Color := RGB(155, 42, 2);
      pnlTabOther.Color := RGB(155, 42, 2);
    end;
  end
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabTrackLabels.Color := RGB(191, 107, 84);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabOther.Color := RGB(191, 107, 84);
