...
//
    //==Platform Instance
    function GetAllPlatformInstance(const aResourceAllocID: Integer; var aRec: TList): Integer;
...
//    function DeleteGameAreaDef(const aGameAreaID: Integer): Boolean;
    ...
    {$REGION ' Vehicle '}
    function GetVehicleDef(const aVehicleID: Integer; var aResult: TVehicle_Definition): boolean;
...
//
//    function GetTorpedoPOHModifier(const aTopedoID: integer; var aList: TList): Integer;
...
//    function DeleteTorpedoPOHModifier(const aIndex: Integer): Boolean;
    {$ENDREGION}
...
//    function DeleteOverlayDef(const aOverlayID: Integer): Boolean;
    ...
    {$REGION ' Motion '}
    function GetMotionCharacteristicDef(const aClassID: Integer; var aMotion: TMotion_Characteristics): boolean;
    {$ENDREGION}

    {$REGION ' Logistic '}
    function GetLogisticDef(const aClassID: Integer; var rec: TLogistic_Characteristics): boolean;
    {$ENDREGION}

    {$REGION ' Transport '}
    function GetTransportDef(const aClassID: Integer; var rec: TTransport): Boolean;
    {$ENDREGION}
...
//    function UpdateWaypointDef(var aRec: TRecWaypoint_Def): Boolean;
//    function DeleteWaypointDef(const aWaypointIndex: Integer): boolean;
//
//    function DeleteWaypointDataPoint(const aWaypointIndex: Integer): boolean;
    {$ENDREGION}
...
//    function DeleteBlindZone(const aOnBoardType, aOnBoardIndex, aBlindZoneNumber: Integer): Boolean; overload;
    ...
    function GetResourceOverlayMapping(const id: Integer;
      var recList: TList): boolean;
    function GetResourcePlottingMapping(const id: Integer;
      var recList: TList):Boolean;
    ...
    function deletePlatformByIndex(const platform_instace_index: string): Integer;

    function getPlatformType(var aRec: TList): Integer;

    // --- 2.1.1 -- Platform Instance Detail --------------------------------------

    function GetAllVehicle_Def(var vList: TList; var id: Integer; var rec: TVehicle_Definition): Integer;
    ...
    function DeleteEO_On_Board(const id: string; var rec: TEO_On_Board): Integer;
    function getEO_Def(const id: Integer; var aRec: TList; var rec: TEO_On_Board): Integer;
...
// -- countermeasure --
    ...
    function GetHosted_Platform(const v_id, host_id: Integer;var aRec: TList): boolean;
    function GetAllHosted_Platform(const v_id, host_id: Integer;var aRec: TList): boolean;
    ...
    function GetResourceRPLMapping(const id: Integer;
    ...
    function GetWaypointMapping(RAid : Integer; WaypointList : TList) : integer; //x
    ...
    function GetResourceBaseMapping(const id: Integer;
	var pList: TList): boolean;
...
function TdmTTT.GetResourceOverlayMapping(const id: Integer; var recList: TList): boolean;
var
...
function TdmTTT.GetResourcePlottingMapping(const id: Integer;
  var recList: TList): Boolean;
var
  rec: TResource_Allocation;
begin
...
//        Init_Logistic := FieldByName('Init_Logistic').AsSingle;
        ...
        Init_Ration := FieldByName('Init_Food').AsSingle;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Init_Fuel := FieldByName('Init_Fuel').AsFloat;
        Init_Lubricants := FieldByName('Init_Lubricants').AsFloat;
        Init_Freshwater := FieldByName('Init_Freshwater').AsFloat;
        Init_Water := FieldByName('Init_Water').AsFloat;
        Init_Ration := FieldByName('Init_Ration').AsFloat;
...
begin
  ...
  begin
    ...
    SQL.Add('b.Width, b.Length, b.DWT, b.Platform_Domain, b.Platform_Type ');
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Weight:= FieldByName('DWT').AsFloat;
...
//      SQL.Add('Init_Logistic =' + FloatToStr(Init_Logistic) + ',');
      ...
      SQL.Add('Init_Ration =' + FloatToStr(Init_Ration) + ',');
...
//      SQL.Add(FloatToStr(Init_Logistic) + ',');
      ...
      SQL.Add(FloatToStr(Init_Ration) + ',');
...
begin
  ...
  GetResourceRPLMapping(allocIndex, recList);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          GetVehicleDef(Vehicle_Index, TVehicle_Definition(aObject));
...
function TdmTTT.GetAllPlatformInstance(const aResourceAllocID: Integer; var aRec: TList): Integer;
var
  //i: Integer;
...
begin
  ...
  begin
    ...
    SQL.Clear;
    SQL.Add('SELECT *');
    SQL.Add('FROM PlatForm_Instance a  JOIN Platform_Activation b ');
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Alert_State_Time := FieldByName('Alert_State_Time').AsSingle;Detectability_Type := FieldByName('Detectability_Type').AsInteger;
        ...
        Logistic_Characteristics := FieldByName('Logistics_Index').AsInteger;
      ...
      begin
        ...
        SQL.Add('ON a.Pattern_Index = b.Pattern_Index ');
        SQL.Add('WHERE a.Vehicle_Index = ' + IntToStr(aResult.FData.Vehicle_Index));
        Open;
        ...
        begin
          ...
          aResult.predefined.Add(predefined);
          ZQ.Next;
        end;
...
// ------------------------------------------------------------------------------
function TdmTTT.getAllEO_On_Board(const id, index: Integer; var aRec: TList): Integer;
var
  i: Integer;
  rec: TEO_On_Board;
...
function TdmTTT.GetTransportDef(const aClassID: Integer; var rec: TTransport): Boolean;
begin
  Result := False;
...
function TdmTTT.GetAllHosted_Platform(const v_id, host_id: Integer; var aRec: TList): boolean;
var
  //i: Integer;
...
begin
  ...
  begin
    ...
    SQL.Add('ON a.Vehicle_Index = b.Vehicle_Index ');
    SQL.Add('WHERE a.Hosted_Vehicle_Index = ' + IntToStr(v_id));
...
function TdmTTT.GetResourceBaseMapping(const id: Integer;
  var pList: TList): boolean;
var
//  rec: TEmbark_Library;
  rec: TPlatformBase;
...
begin
  ...
  begin
    ...
    begin
      ...
      while not ZQ.Eof do
      begin
        rec:= TPlatformBase.Create; {create objek pangkalan}
...
function TdmTTT.GetWaypointMapping(RAid : Integer; WaypointList : TList) : integer; //x
var
...
function TdmTTT.GetHosted_Platform(const v_id, host_id: Integer; var aRec: TList): boolean;
var
  //i: Integer;
  rec: THosted_Platform;
  ssql: string;
...
function TdmTTT.GetLogisticDef(const aClassID: Integer; var rec: TLogistic_Characteristics): boolean;
begin
  result := false;
  ...
  begin
    ...
    begin
      ...
      with rec.FData do
      begin
        Logistics_Index := ZQ.FieldByName('Logistic_Index').AsInteger;
        Logistics_Identifier := ZQ.FieldByName('Logistic_Identifier').AsString;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ShapeType       := FieldByName('Shape_ID').AsInteger;
...
function TdmTTT.GetResourceRPLMapping(const id: Integer; var pList: TList): boolean;
var
  ssql: string;
  rec: TRuntime_Platform_Library;
  i: Integer;
