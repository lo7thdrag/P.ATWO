...
begin
  ...
  case index of
    ...
    E_Rain_Rate                       :
                                      begin
                                        frmToteDisplay.edtRainRate.Text := FormatFloat('0.00', Value);
                                        frmToteDisplay.lblAttenuationFactorsRain.Caption := FormatFloat('0.00', Value);
                                        frmToteDisplay.trbRainRate.Position := Round(Value);
    ...
    E_Cloud_Attenuation               :
                                      begin
                                        frmToteDisplay.edtCloud.Text := FormatFloat('0.00', Value);
                                        frmToteDisplay.trbCloud.Position := Round(Value);
    ...
    E_Sea_State                       :
                                      begin
                                        frmToteDisplay.edtSea.Text := FormatFloat('0.00', Value);
                                        frmToteDisplay.trbSea.Position := Round(Value);
