...
uses
  ...
  ufrmOverlayEditor in '..\LibTTT\forms\ufrmOverlayEditor.pas' {frmOverlayEditor},
  ...
  ufrmRuler in '..\LibTTT\forms\ufrmRuler.pas' {frmRuler};
...
//  ReportMemoryLeaksOnShutdown:= True;
  ...
  Application.CreateForm(TfrmOverlayEditor, frmOverlayEditor);
