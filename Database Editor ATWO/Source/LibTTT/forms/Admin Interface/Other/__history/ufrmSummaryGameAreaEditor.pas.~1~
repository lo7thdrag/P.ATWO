...
//  btnSelect.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnCursor_Select.PNG');
end;
...
//  btnZoom.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnZoomIn_Select.PNG');
end;
...
//  btnCenterOnGameCenter.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnCenterOnHook_Select.PNG');
end;
...
//  btnPan.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnMove_Select.PNG');
end;

procedure TfrmSummaryGameAreaEditor.LoadNormalButtonImage;
begin
//  btnSelect.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnCursor_Normal.PNG');
//  btnZoom.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnZoomIn_Normal.PNG');
//  btnCenterOnGameCenter.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnCenterOnHook_Normal.PNG');
//  btnPan.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnMove_Normal.PNG');
end;
...
begin
  ...
  lblSlPosition.Caption := formatDMS_latt(yy);
