...
begin
  ...
  FSisaSpaceHull := FPlatformInstance.Transport.FData.Deck_Width * FPlatformInstance.Transport.FData.Deck_Length;
...
begin
  ...
  FSisaSpaceHull := (FPlatformInstance.Transport.FData.Deck_Width * FPlatformInstance.Transport.FData.Deck_Length) - FCurrentSpaceHull;
