...
begin
  ...
  begin
    ...
    btnVehicle.BringToFront;
    btnBase.BringToFront;
    btnOverlay.BringToFront;
//    btnVehicle.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnVehicle_Blue.PNG');
//    btnBase.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnBase_Blue.PNG');
//    btnOverlay.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnOverlay_Blue.PNG');
  end
  else
  begin
    FSelectedForce := 1;

    btnVehicleRed.BringToFront;
    btnBaseRed.BringToFront;
    btnOverlayRed.BringToFront;
//    btnVehicle.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnVehicle_Red.PNG');
//    btnBase.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnBase_Red.PNG');
//    btnOverlay.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnOverlay_Red.PNG');
  end;
end;
...
//    btnGroup.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnGroup_Blue.PNG');
  end
  else
  begin
    FSelectedForce2 := 1;

    btnGroupRed.BringToFront;
//    btnGroup.Picture.LoadFromFile('dataATWO\Image DBEditor\Interface\Button\btnGroup_Red.PNG');
  end;
end;
