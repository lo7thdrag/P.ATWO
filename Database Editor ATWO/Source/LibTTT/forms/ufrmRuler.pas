...
type
  ...
  public
    { Public declarations }
    isShow : Boolean;
    IDForm : Integer; {0: Waypoint; 1: Overlay}
    MapRuller : TMap;
    ruler : TDrawRuler;
...
procedure TfrmRuler.btnCloseClick(Sender: TObject);
begin
Close;
end;
    ...
    case FTagBtnPosition of
      ...
      begin
        case IDForm of
          ...
          1:
          begin
            frmOverlayEditor.Map1.CurrentTool := miArrowTool;
            frmOverlayEditor.Map1.MousePointer := miCrossCursor;
            frmOverlayEditor.MapCursor := mcRulerStart;
          end;
        end;
      ...
      begin
        case IDForm of
          ...
          begin
            frmOverlayEditor.Map1.CurrentTool := miArrowTool;
            frmOverlayEditor.Map1.MousePointer := miCrossCursor;
            frmOverlayEditor.MapCursor := mcRulerEnd;
          end;
        end;
...
begin
  ...
  frmOverlayEditor.Map1.Repaint;

  frmOverlayEditor.ClearFlagPoint;
...
begin
  ...
  case IDForm of
    ...
    {$REGION ' Waypoint Section '}
    0:
    begin
      frmWaypointEditor.Map1.MousePointer := miCrossCursor;
      frmWaypointEditor.Map1.Repaint;
      frmWaypointEditor.btnRuller.ImageIndex := 11;
    end;
    {$ENDREGION}
    ...
    begin
      frmOverlayEditor.Map1.MousePointer := miCrossCursor;
      frmOverlayEditor.ClearFlagPoint;
      frmOverlayEditor.btnRuller.ImageIndex := 11;
      frmOverlayEditor.Map1.Repaint;
    end;
    {$ENDREGION}
