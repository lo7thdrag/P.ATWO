...
type
  TfrmAmphibiousView = class(TForm)
    ImgBackground: TImage;
    lstAmphibious: TListBox;
    Label4: TLabel;
    Label2: TLabel;
    lblName: TLabel;
    pnlTabChar: TPanel;
  ...
  private
    ...
    FPlatInstList : TList;
    FAmphibiousVehicleList : TList;
    FSelectedAmphibiousVehicle : TVehicle_Definition;
  public
    { Public declarations }

    procedure UpdateTabPage;
    procedure UpdateModelPanel;
    procedure UpdateAmphibiousVehicleList;
    procedure UpdateAmphibiousVehicleData;
...
var
  frmAmphibiousView: TfrmAmphibiousView;
...
procedure TfrmAmphibiousView.ImgBtnBackClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmAmphibiousView.ImgBtnNextTabClick(Sender: TObject);
begin
  tabIndex := tabIndex + 1;
  UpdateTabPage
end;

procedure TfrmAmphibiousView.ImgBtnPreviousTabClick(Sender: TObject);
begin
  tabIndex := tabIndex - 1;
  UpdateTabPage
end;

procedure TfrmAmphibiousView.ImgBtnNextModelClick(Sender: TObject);
begin
...
procedure TfrmAmphibiousView.ImgBtnPreviousModelClick(Sender: TObject);
begin
  modelIndex := modelIndex - 1;
  UpdateModelPanel
end;

procedure TfrmAmphibiousView.lbSingleClick(Sender: TObject);
begin
  if lstAmphibious.ItemIndex = -1 then
    Exit;

  FSelectedAmphibiousVehicle := TVehicle_Definition(lstAmphibious.Items.Objects[lstAmphibious.ItemIndex]);

  UpdateAmphibiousVehicleData;
end;

procedure TfrmAmphibiousView.btnAssetClick(Sender: TObject);
begin
  if Assigned (FSelectedAmphibiousVehicle) then
  begin
    frmAssetDetail := TfrmAssetDetail.Create(Self);
    try
      with frmAssetDetail do
      begin
        SelectedVehicle := FSelectedAmphibiousVehicle;
...
procedure TfrmAmphibiousView.UpdateAmphibiousVehicleData;
var
  i : Integer;
...
begin
  with FSelectedAmphibiousVehicle do
  begin
...
procedure TfrmAmphibiousView.UpdateAmphibiousVehicleList;
var
  i : Integer;
  amphibiousvehicle : TVehicle_Definition;
begin
  ...
  dmTTT.GetFilterVehicleDefByDomain(FAmphibiousVehicleList, Ord(vhdAmphibious));
...
procedure TfrmAmphibiousView.UpdateMotionData;
var
  motion : TMotion_Characteristics;
begin
  with FSelectedAmphibiousVehicle.FData do
  begin
...
procedure TfrmAmphibiousView.UpdateCbbCategoryItems;
begin
  with FSelectedAmphibiousVehicle do
  begin
    case FData.Platform_Domain of
...
procedure TfrmAmphibiousView.UpdateCbbTypeItems;
begin
  with FSelectedAmphibiousVehicle.FData do
  begin
    {$REGION ' Air '}
...
procedure TfrmAmphibiousView.UpdatePIIdentData;
var
  i : Integer;
  PIIdentifer : TPlatform_Instance_Identifier;
begin
  dmTTT.GetAllPlatformInstanceIdentifier(FSelectedAmphibiousVehicle.FData.Vehicle_Index, FPlatInstList);
...
procedure TfrmAmphibiousView.UpdateModelPanel;
var
  i : Integer;
  PIIdentifer : TPlatform_Instance_Identifier;
begin
...
procedure TfrmAmphibiousView.UpdateTabPage;
begin
