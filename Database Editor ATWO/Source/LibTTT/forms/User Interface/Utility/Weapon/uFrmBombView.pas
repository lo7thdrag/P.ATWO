...
procedure TfrmBombView.ImgBtnNextTabClick(Sender: TObject);
begin
  tabIndex := tabIndex + 1;
  UpdateTabPage
end;
...
//    cbbType.ItemIndex := FData.Bomb_Type;
    ...
    case FData.Bomb_Type of
      Ord(btBomb) : edtTypeBomb.Caption := btsBomb;
      Ord(btDepthCharge) : edtTypeBomb.Caption := btsDepthCharge;
      Ord(btRocket) : edtTypeBomb.Caption := btsRocket;
    end;
