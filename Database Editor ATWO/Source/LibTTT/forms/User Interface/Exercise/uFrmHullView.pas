...
uses
  ...
  uSimContainers, Vcl.Imaging.jpeg, tttData, uDBAsset_Vehicle, uDBEditSetting;
...
begin
  ...
  try
    ImgShipModel.Picture.LoadFromFile(vAppDBSetting.InterfacePath + 'Image DBEditor\Interface\' + HostShip.FData.vbs_class_name + '.PNG');
  except
    ImgShipModel.Picture.LoadFromFile(vAppDBSetting.InterfacePath + 'Image DBEditor\Interface\NoModel.bmp');
  end;
...
begin
  ...
  begin
    ...
    try
      ImgPlatformModel.Picture.LoadFromFile(vAppDBSetting.InterfacePath + 'Image DBEditor\Interface\' + FSelectedPlatform.FData.vbs_class_name + '.PNG');
    except
      ImgPlatformModel.Picture.LoadFromFile(vAppDBSetting.InterfacePath + 'Image DBEditor\Interface\NoModel.bmp');
    end;
  end;
end;
