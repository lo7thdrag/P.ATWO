...
var
  frmOverlayEditor: TfrmOverlayEditor;
...
procedure TfrmOverlayEditor.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  IsReEdit := True;
end;

procedure TfrmOverlayEditor.FormCreate(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.FormShow(Sender: TObject);
var
...
procedure TfrmOverlayEditor.btnDeleteClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.btnHandleShape(Sender: TObject);
var
  isDynamic: Boolean;
begin
...
//  ShapeType := TImage(Sender).Tag;
  ShapeType := TRzBmpButton(Sender).Tag;
  case ShapeType of
    0: { Select }
      begin
//        btnSelect.Picture.LoadFromFile
//          ('dataATWO\Image DBEditor\Interface\Button\btnCursor_Select.PNG');
        lblShape.Caption := '---';
        grpNone.BringToFront;
...
procedure TfrmOverlayEditor.btnSave(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.btnoutClick(Sender: TObject);
begin
...
//  btnSelect.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnCursor_Normal.PNG');
  pnlStatic.Visible := false;
  btnout.ImageIndex := 8;
end;

procedure TfrmOverlayEditor.mnitoBackClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.mnitoFrontClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.LoadPanelText;
begin
  lblShape.Caption := 'Text';
//  btnText.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnText_Select.PNG');
...
procedure TfrmOverlayEditor.LoadPanelLine;
begin
  lblShape.Caption := 'Line';
//  btnLine.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnLine_Select.PNG');
...
procedure TfrmOverlayEditor.LoadPanelRectangle;
begin
  lblShape.Caption := 'Rectangle';
//  btnRectangle.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnRectangle_Select.PNG');
...
procedure TfrmOverlayEditor.LoadPanelCircle;
begin
  lblShape.Caption := 'Circle';
//  btnCircle.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnCircle_Select.PNG');
...
procedure TfrmOverlayEditor.LoadPanelEllipse;
begin
  lblShape.Caption := 'Ellipse';
//  btnEllipse.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnEllipse_Select.PNG');
...
procedure TfrmOverlayEditor.LoadPanelArc;
begin
  lblShape.Caption := 'Arc';
//  btnArc.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnArc_Select.PNG');
...
procedure TfrmOverlayEditor.LoadPanelSector;
begin
  lblShape.Caption := 'Sector';
//  btnSector.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnSector_Select.PNG');
...
procedure TfrmOverlayEditor.LoadPanelGrid;
begin
  lblShape.Caption := 'Grid';
//  btnGrid.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnGrid_Select.PNG');
...
procedure TfrmOverlayEditor.LoadPanelPolygon;
begin
  lblShape.Caption := 'Polygon';
//  btnPolygon.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnPolygon_Select.PNG');
...
procedure TfrmOverlayEditor.GbrText;
var
  Size: Integer;
...
procedure TfrmOverlayEditor.GbrLine;
var
...
procedure TfrmOverlayEditor.GbrRectangle;
var
...
procedure TfrmOverlayEditor.GbrCircle;
var
...
procedure TfrmOverlayEditor.GbrEllipse;
var
...
procedure TfrmOverlayEditor.GbrArc;
var
...
procedure TfrmOverlayEditor.GbrSector;
var
...
procedure TfrmOverlayEditor.GbrGrid;
var
...
procedure TfrmOverlayEditor.GbrPolygon;
var
  i: Integer;
  li: TListItem;
  Point: TDotDynamic;
...
procedure TfrmOverlayEditor.GbrFlagPoint(mx, my: Double);
var
...
procedure TfrmOverlayEditor.EditFlagPoint(id: Integer; mx, my: Double);
var
  ObjectFlagPoint: TFlagPoint;
begin
  ObjectFlagPoint := TFlagPoint.Create(FConverter);
...
procedure TfrmOverlayEditor.LoadMap(Geoset: String);
var
  i: Integer;
  z: OleVariant;
...
procedure TfrmOverlayEditor.LoadNormalButtonImage;
begin
...
procedure TfrmOverlayEditor.Map1DrawUserLayer(ASender: TObject;
...
procedure TfrmOverlayEditor.Map1MapViewChanged(Sender: TObject);
var
  tempZoom: Double;
begin
...
procedure TfrmOverlayEditor.Map1MouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
// var
// xx: Double;
// yy: Double;
...
procedure TfrmOverlayEditor.Map1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TfrmOverlayEditor.Map1MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  pos: TPoint;
begin
...
procedure TfrmOverlayEditor.btnIncreaseClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.btnDecreaseClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.btnZoomClick(Sender: TObject);
begin
  // if btnZoom.Down then
  // btnZoom.Down := False;
...
procedure TfrmOverlayEditor.btnPanClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.btnCenterGameClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.GameCenterDynamic;
var
...
procedure TfrmOverlayEditor.OnAddRuller(Long, Lat: double);
begin
...
procedure TfrmOverlayEditor.OnKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmOverlayEditor.OnKeyPressTextSize(Sender: TObject; var Key: Char);
begin
...
procedure TfrmOverlayEditor.pnlWarningClick(Sender: TObject);
begin
  pnlWarning.Visible := false;
end;

function TfrmOverlayEditor.RecordToFileStream(fFile: String): Boolean;
var
  Fs: TFileStream;
begin
  Result := True;
...
procedure TfrmOverlayEditor.RefreshForm;
begin
//Caption := 'Overlay Name : ' + SelectedOverlay.FData.Name;
...
procedure TfrmOverlayEditor.RefreshLvPolyVertexList;
var
  j: Integer;
  ObjectFlagPoint: TFlagPoint;
  li: TListItem;
...
procedure TfrmOverlayEditor.RefreshMousePointer;
begin
...
//    ('dataATWO\Image DBEditor\Interface\Button\btnCursor_Normal.PNG');
//  btnText.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnText_Normal.PNG');
//  btnLine.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnLine_Normal.PNG');
//  btnRectangle.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnRectangle_Normal.PNG');
//  btnCircle.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnCircle_Normal.PNG');
//  btnEllipse.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnEllipse_Normal.PNG');
//  btnArc.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnArc_Normal.PNG');
//  btnSector.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnSector_Normal.PNG');
//  btnGrid.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnGrid_Normal.PNG');
//  btnPolygon.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnPolygon_Normal.PNG');

  FisNoFill := True;
end;

procedure TfrmOverlayEditor.GetPosition;
begin
...
function TfrmOverlayEditor.GetInput(s: string): Boolean;
var
  a, i: Integer;
begin
  Result := false;
...
function TfrmOverlayEditor.GetGridLatt(yCursorPoint: Double): string;
var
...
procedure TfrmOverlayEditor.getGridCursorPos;
var
...
procedure TfrmOverlayEditor.ClearEditText;
begin
...
procedure TfrmOverlayEditor.ClearFlagPoint;
begin
  DrawFlagPoint.FList.Clear;
  Map1.Refresh;
  Map1.Repaint;
...
procedure TfrmOverlayEditor.LoadShape(fFile: String);
var
  Fs: TFileStream;
begin
...
procedure TfrmOverlayEditor.lvPolyVertexSelectItem(Sender: TObject;
...
procedure TfrmOverlayEditor.setCBScale;
var
  widthNM: Integer;
...
procedure TfrmOverlayEditor.SetNoFill(val: Boolean);
begin
  if val then
  begin
    FisNoFill := True;
...
procedure TfrmOverlayEditor.btnNoFillClick(Sender: TObject);
begin
  case ShapeType of
...
procedure TfrmOverlayEditor.btnCloseClick(Sender: TObject);
begin
  RefreshMousePointer;
  btnPan.Down := false;
  btnZoom.Down := false;
...
procedure TfrmOverlayEditor.btnDeletePolyClick(Sender: TObject);
begin
  lvPolyVertex.Clear;
  ClearFlagPoint;
  ClearEditText;
...
procedure TfrmOverlayEditor.btnDeletePolyDClick(Sender: TObject);
begin
  lvPolyVertexD.Clear;
end;

procedure TfrmOverlayEditor.btnDelPolyClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.btnEditPolyClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.btnFillClick(Sender: TObject);
begin
//  btnFill.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnFill_Select.PNG');
//  btnOutline.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnOutline_Normal.PNG');

  FShapeColor := scFill;
  // btnNoFill.OnClick(btnNoFill);
end;

procedure TfrmOverlayEditor.btnGameAreaClick(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.btnOutlineClick(Sender: TObject);
begin
//  btnOutline.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnOutline_Select.PNG');
//  btnFill.Picture.LoadFromFile
//    ('dataATWO\Image DBEditor\Interface\Button\btnFill_Normal.PNG');

  FShapeColor := scOutline;
end;

procedure TfrmOverlayEditor.btnHandleShapePosition(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.Canceled;
var
  j: Integer;
...
procedure TfrmOverlayEditor.cbbDashesPenSelect(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.cbSetScaleChange(Sender: TObject);
var
  z: Double;
  s: string;
begin
...
procedure TfrmOverlayEditor.colorChooseChange(Sender: TObject);
begin
...
procedure TfrmOverlayEditor.edtArcRadiusChange(Sender: TObject);
var
...
procedure TfrmOverlayEditor.SelectShape(pos: TPoint);
begin
...
procedure TfrmOverlayEditor.cbbDashesPenDSelect(Sender: TObject);
begin
  if cbbDashesPen.Text = 'Solid' then
  begin
    cbbWeightPen.Enabled := True;
