...
begin
  ...
  begin
    ...
    begin
      ...
      for i := 0 to frmOverlayEditor.lvPolyVertexD.Items.Count - 1 do
      begin
        li := frmOverlayEditor.lvPolyVertexD.Items[i];
  ...
  begin
    ...
    begin
      ...
      for i := 0 to frmOverlayEditor.lvPolyVertex.Items.Count - 1 do
      begin
        li := frmOverlayEditor.lvPolyVertex.Items[i];
...
case linetype of
    TPenStyle(psSolid) :
      begin
        Result := 'Solid' ;
        frmOverlayEditor.cbbDashesPen.ItemIndex := 0;
      end;
    TPenStyle(psDash):
      begin
        Result := 'Dash';
        frmOverlayEditor.cbbDashesPen.ItemIndex := 1;
      end;
    TPenStyle(psDot):
      begin
        Result := 'Dot';
        frmOverlayEditor.cbbDashesPen.ItemIndex := 2;
      end;
    TPenStyle(psDashDot):
      begin
        Result := 'Dash Dot';
        frmOverlayEditor.cbbDashesPen.ItemIndex := 3;
      end;
    TPenStyle(psDashDotDot):
      begin
        Result := 'Dash Dot Dot';
        frmOverlayEditor.cbbDashesPen.ItemIndex := 4;
      end;
  end;
end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.edtTextRange.Text     := FloatToStr(postStart.Range);
          frmOverlayEditor.edtTextBearing.Text   := FloatToStr(postStart.Bearing);
          frmOverlayEditor.edtTextFieldD.Text    := words;
...
//          OverlayEditorForm.pnlNoFill.Visible := False;
          ...
          frmOverlayEditor.cbbTextSizeD.Text     := IntToStr(OText.size);

          frmOverlayEditor.ShapeType := ovText;
          frmOverlayEditor.lblShape.Caption := 'Text';
          frmOverlayEditor.grpTextD.BringToFront;
          frmOverlayEditor.pnlPenEditing.Visible := False;
          frmOverlayEditor.btnFill.Enabled := False;
          frmOverlayEditor.btnOutline.Enabled := True;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.edtLineStartRange.Text    := FloatToStr(postStart.Range);
          frmOverlayEditor.edtLineStartBearing.Text  := FloatToStr(postStart.Bearing);
          frmOverlayEditor.edtLineEndRange.Text      := FloatToStr(postEnd.Range);
          frmOverlayEditor.edtLineEndBearing.Text    := FloatToStr(postEnd.Bearing);
...
//          frmOverlayEditor.pnlNoFill.Visible := False;
          ...
          frmOverlayEditor.ShapeType := ovLine;
          frmOverlayEditor.lblShape.Caption := 'Line';
          frmOverlayEditor.grpLineD.BringToFront;

          frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(OLine.LineType);

          frmOverlayEditor.cbbWeightPen.Text := IntToStr(OLine.weight);

          frmOverlayEditor.pnlPenEditing.Visible := True;
          frmOverlayEditor.btnFill.Enabled := False;
          frmOverlayEditor.btnOutline.Enabled := True;
          IdSelected := countList;
          break;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.edtRecStartRange.Text   := FloatToStr(postStart.Range);
          frmOverlayEditor.edtRecStartBearing.Text := FloatToStr(postStart.Bearing);
          frmOverlayEditor.edtRecEndRange.Text     := FloatToStr(postEnd.Range);
          frmOverlayEditor.edtRecEndBearing.Text   := FloatToStr(postEnd.Bearing);
//          OverlayEditorForm.txtColorSelect.color    := ORectangle.color;

          frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(ORectangle.LineType);

          frmOverlayEditor.cbbWeightPen.Text := IntToStr(ORectangle.weight);
...
//            FisNoFill := False;
          ...
          frmOverlayEditor.ShapeType := ovRectangle;
          frmOverlayEditor.lblShape.Caption := 'Rectangle';
          frmOverlayEditor.grpRectangleD.BringToFront;
          frmOverlayEditor.pnlPenEditing.Visible := True;
          frmOverlayEditor.btnFill.Enabled := False;
          frmOverlayEditor.btnOutline.Enabled := True;
          IdSelected := countList;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.edtCircleRange.Text   := FloatToStr(postCenter.Range);
          frmOverlayEditor.edtCircleBearing.Text := FloatToStr(postCenter.Bearing);
          frmOverlayEditor.edtCircleRadiusD.Text := FloatToStr(radius);
//          frmOverlayEditor.txtColorSelect.color  := OCircle.color;

          frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(OCircle.LineType);

          frmOverlayEditor.cbbWeightPen.Text := IntToStr(OCircle.weight);
...
//            FisNoFill := False;
          ...
          frmOverlayEditor.ShapeType := ovCircle;
          frmOverlayEditor.lblShape.Caption := 'Circle';
          frmOverlayEditor.pnlPenEditing.Visible := True;
          frmOverlayEditor.btnFill.Enabled := True;
          frmOverlayEditor.btnOutline.Enabled := True;
          frmOverlayEditor.grpCircleD.BringToFront;
          frmOverlayEditor.grpCircleD.Visible := True;
          IdSelected := countList;
          break;
        end;
      end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.edtEllipseRange.Text        := FloatToStr(postCenter.Range);
          frmOverlayEditor.edtEllipseBearing.Text      := FloatToStr(postCenter.Bearing);
          frmOverlayEditor.edtEllipseHorizontalD.Text  := FloatToStr(OEllipse.Hradius);
          frmOverlayEditor.edtEllipseVerticalD.Text  := FloatToStr(OEllipse.Vradius);
//          frmOverlayEditor.txtColorSelect.color  := OEllipse.color;

          frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(OEllipse.LineType);

          frmOverlayEditor.cbbWeightPen.Text := IntToStr(OEllipse.weight);
...
//            FisNoFill := False;
          ...
          frmOverlayEditor.ShapeType := ovEllipse;
          frmOverlayEditor.lblShape.Caption := 'Ellipse';
          frmOverlayEditor.grpEllipseD.BringToFront;
          frmOverlayEditor.pnlPenEditing.Visible := True;
          frmOverlayEditor.btnFill.Enabled := True;
          frmOverlayEditor.btnOutline.Enabled := True;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.edtArcRange.Text        := FloatToStr(postCenter.Range);
          frmOverlayEditor.edtArcBearing.Text      := FloatToStr(postCenter.Bearing);
          frmOverlayEditor.edtArcRadiusD.Text      := FloatToStr(radius);
          frmOverlayEditor.edtArcStartAngleD.Text  := FloatToStr(StartAngle);
          frmOverlayEditor.edtArcEndAngleD.Text    := FloatToStr(EndAngle);
//          frmOverlayEditor.txtColorSelect.color  := OArc.color;

          frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(OArc.LineType);

          frmOverlayEditor.cbbWeightPen.Text := IntToStr(OArc.weight);
          frmOverlayEditor.ShapeType := ovArc;
          frmOverlayEditor.lblShape.Caption := 'Arc';
          frmOverlayEditor.grpArcD.BringToFront;
          frmOverlayEditor.pnlPenEditing.Visible := True;
          frmOverlayEditor.btnFill.Enabled := False;
          frmOverlayEditor.btnOutline.Enabled := True;
          IdSelected := countList;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.edtSectorRange.Text       := FloatToStr(postCenter.Range);
          frmOverlayEditor.edtSectorBearing.Text     := FloatToStr(postCenter.Bearing);
          frmOverlayEditor.edtSectorInnerD.Text      := FloatToStr(Iradius);
          frmOverlayEditor.edtSectorOuterD.Text      := FloatToStr(Oradius);
          frmOverlayEditor.edtSectorStartAngleD.Text := FloatToStr(StartAngle);
          frmOverlayEditor.edtSectorEndAngleD.Text   := FloatToStr(EndAngle);
//          frmOverlayEditor.txtColorSelect.color  := OSector.color;

          frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(OSector.LineType);

          frmOverlayEditor.cbbWeightPen.Text := IntToStr(OSector.weight);
...
//            FisNoFill := False;
          ...
          frmOverlayEditor.ShapeType := ovSector;
          frmOverlayEditor.lblShape.Caption := 'Sector';
          frmOverlayEditor.grpSectorD.BringToFront;
          frmOverlayEditor.pnlPenEditing.Visible := True;
          frmOverlayEditor.btnFill.Enabled := False;
          frmOverlayEditor.btnOutline.Enabled := True;
          IdSelected := countList;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.edtTableRange.Text        := FloatToStr(postCenter.Range);
          frmOverlayEditor.edtTableBearing.Text      := FloatToStr(postCenter.Bearing);
          frmOverlayEditor.edtTableColumnD.Text      := FloatToStr(OGrid.HCount);
          frmOverlayEditor.edtTableRowD.Text         := FloatToStr(OGrid.WCount);
          frmOverlayEditor.edtTableHeightD.Text      := FloatToStr(OGrid.Height);
          frmOverlayEditor.edtTableWidthD.Text       := FloatToStr(OGrid.Width);
          frmOverlayEditor.edtRotationAngleD.Text    := FloatToStr(OGrid.Rotation);
//          frmOverlayEditor.txtColorSelect.color  := OGrid.color;

          frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(OGrid.LineType);

          frmOverlayEditor.cbbWeightPen.Text := IntToStr(OGrid.weight);

          frmOverlayEditor.ShapeType := ovGrid;
          frmOverlayEditor.lblShape.Caption := 'Grid';
          frmOverlayEditor.grpGridD.BringToFront;
          frmOverlayEditor.pnlPenEditing.Visible := True;
          frmOverlayEditor.btnFill.Enabled := False;
          frmOverlayEditor.btnOutline.Enabled := True;
          IdSelected := countList;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            frmOverlayEditor.lvPolyVertexD.Clear;

            for k := 0 to polyList.Count - 1 do
            begin
              point := polyList.Items[k];

              with frmOverlayEditor.lvPolyVertexD.Items.Add do
              begin
            ...
            frmOverlayEditor.lvPolyVertexD.Items.BeginUpdate;
            try
             for k := 0 to frmOverlayEditor.lvPolyVertexD.Items.Count-1 do
               frmOverlayEditor.lvPolyVertexD.Items.Item[k].Caption:=IntToStr(k+1);
            finally
              frmOverlayEditor.lvPolyVertexD.Items.EndUpdate;
            end;
//            frmOverlayEditor.txtColorSelect.color  := OPolygon.color;

            frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(OPolygon.LineType);

            frmOverlayEditor.cbbWeightPen.Text := IntToStr(OPolygon.weight);
...
//              FisNoFill := False;
            ...
            frmOverlayEditor.ShapeType := ovPolygon;
            frmOverlayEditor.lblShape.Caption := 'Polygon';
            frmOverlayEditor.grpPolygonD.BringToFront;
            frmOverlayEditor.pnlPenEditing.Visible := True;
            frmOverlayEditor.btnFill.Enabled := True;
            frmOverlayEditor.btnOutline.Enabled := True;
            IdSelected := countList;
  ...
  begin
    ...
    begin
      ...
      if frmOverlayEditor.btnPan.Down = true then
      begin
        frmOverlayEditor.Map1.CurrentTool := miSelectTool;
        frmOverlayEditor.Map1.MousePointer := miDefaultCursor;
        frmOverlayEditor.btnPan.Down := false;
        frmOverlayEditor.LoadNormalButtonImage;
      end;
    end;
  end
  else
  begin
    ...
    begin
      ...
      if frmOverlayEditor.btnPan.Down = false then
      begin
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.btnSelect.OnClick(btnSelect);
        frmOverlayEditor.btnDelete.Enabled := false;
      end;
    end;
  end;
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.LoadPanelText;

        frmOverlayEditor.ShapeType := ovText;
        frmOverlayEditor.edtTextPosLat.Text  := formatDMS_latt(SText.postStart.Y);
        frmOverlayEditor.edtTextPosLong.Text := formatDMS_long(SText.postStart.X);
        frmOverlayEditor.cbbTextSize.Text    := IntToStr(SText.size);
        frmOverlayEditor.edtTextField.Text   := SText.words;
        frmOverlayEditor.pnlOutline.color    := SText.Color;
    ...
    begin
      ...
      begin
        ...
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.LoadPanelLine;

        frmOverlayEditor.ShapeType := ovLine;
        frmOverlayEditor.edtLineStartPosLat.Text := formatDMS_latt(SLine.postStart.Y);
        frmOverlayEditor.edtLineStartPosLong.Text := formatDMS_long(SLine.postStart.X);
        frmOverlayEditor.edtLineEndPosLat.Text := formatDMS_latt(SLine.postEnd.Y);
        frmOverlayEditor.edtLineEndPosLong.Text := formatDMS_long(SLine.postEnd.X);
        frmOverlayEditor.pnlOutline.color := SLine.Color;
        frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(SLine.LineType);
        frmOverlayEditor.cbbWeightPen.Text := IntToStr(SLine.weight);
    ...
    begin
      ...
      begin
        ...
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.LoadPanelRectangle;

        frmOverlayEditor.ShapeType := ovRectangle;
        frmOverlayEditor.edtRectStartPosLong.Text  := formatDMS_long(SRectangle.postStart.X);
        frmOverlayEditor.edtRectStartPosLat.Text   := formatDMS_latt(SRectangle.postStart.Y);
        frmOverlayEditor.edtRectEndPosLong.Text    := formatDMS_long(SRectangle.postEnd.X);
        frmOverlayEditor.edtRectEndPosLat.Text     := formatDMS_latt(SRectangle.postEnd.Y);
        frmOverlayEditor.pnlOutline.color          := SRectangle.color;

        frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(SRectangle.LineType);
        frmOverlayEditor.cbbWeightPen.Text := IntToStr(SRectangle.weight);

        if SRectangle.BrushStyle = bsClear then
        begin
          frmOverlayEditor.SetNoFill(True);
        end
        else
        begin
          frmOverlayEditor.SetNoFill(False);
          frmOverlayEditor.PnlFill.Color := SRectangle.ColorFill;
        end;
    ...
    begin
      ...
      begin
        ...
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.LoadPanelCircle;

        frmOverlayEditor.ShapeType := ovCircle;
        frmOverlayEditor.edtCirclePosLong.Text := formatDMS_long(SCircle.postCenter.X);
        frmOverlayEditor.edtCirclePosLat.Text := formatDMS_latt(SCircle.postCenter.Y);
        frmOverlayEditor.edtCircleRadius.Text := FloatToStr(SCircle.radius);
        frmOverlayEditor.pnlOutline.color := SCircle.color;

        frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(SCircle.LineType);
        frmOverlayEditor.cbbWeightPen.Text := IntToStr(SCircle.weight);
        ...
        begin
          frmOverlayEditor.SetNoFill(False);
          frmOverlayEditor.pnlFill.Color := SCircle.ColorFill;
        end;
    ...
    begin
      ...
      begin
        ...
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.LoadPanelEllipse;

        frmOverlayEditor.ShapeType := ovEllipse;
        frmOverlayEditor.edtEllipsePosLong.Text := formatDMS_long(SEllipse.postCenter.X);
        frmOverlayEditor.edtEllipsePosLat.Text  := formatDMS_latt(SEllipse.postCenter.Y);
        frmOverlayEditor.edtHorizontal.Text := FloatToStr(SEllipse.Hradius);
        frmOverlayEditor.edtVertical.Text := FloatToStr(SEllipse.Vradius);
        frmOverlayEditor.pnlOutline.color := SEllipse.color;

        frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(SEllipse.LineType);
        frmOverlayEditor.cbbWeightPen.Text := IntToStr(SEllipse.weight);
        ...
        begin
          frmOverlayEditor.SetNoFill(False);
          frmOverlayEditor.pnlFill.Color := SEllipse.ColorFill;
        end;
    ...
    begin
      ...
      begin
        ...
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.LoadPanelArc;

        frmOverlayEditor.ShapeType := ovArc;
        frmOverlayEditor.edtArcPosLong.Text := formatDMS_long(SArc.postCenter.X);
        frmOverlayEditor.edtArcPosLat.Text := formatDMS_latt(SArc.postCenter.Y);
        frmOverlayEditor.edtArcRadius.Text := FloatToStr(SArc.radius);
        frmOverlayEditor.edtArcStartAngle.Text := IntToStr(SArc.StartAngle);
        frmOverlayEditor.edtArcEndAngle.Text := IntToStr(SArc.EndAngle);
        frmOverlayEditor.pnlOutline.color := SArc.color;
        frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(SArc.LineType);
        frmOverlayEditor.cbbWeightPen.Text := IntToStr(SArc.weight);
    ...
    begin
      ...
      begin
        ...
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.LoadPanelSector;

        frmOverlayEditor.ShapeType := ovSector;
        frmOverlayEditor.edtSectorPosLong.Text := formatDMS_long(SSector.postCenter.X);
        frmOverlayEditor.edtSectorPosLat.Text := formatDMS_latt(SSector.postCenter.Y);
        frmOverlayEditor.edtSectorStartAngle.Text  := IntToStr(SSector.StartAngle);
        frmOverlayEditor.edtSectorEndAngle.Text    := IntToStr(SSector.EndAngle);
        frmOverlayEditor.edtSectorInner.Text  := FloatToStr(SSector.Iradius);
        frmOverlayEditor.edtSectorOuter.Text  := FloatToStr(SSector.Oradius);
        frmOverlayEditor.pnlOutline.color :=  SSector.color;


        frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(SSector.LineType);
        frmOverlayEditor.cbbWeightPen.Text := IntToStr(SSector.weight);
    ...
    begin
      ...
      begin
        ...
        frmOverlayEditor.RefreshMousePointer;
        frmOverlayEditor.LoadPanelGrid;

        frmOverlayEditor.ShapeType := ovGrid;
        frmOverlayEditor.edtTablePosLong.Text := formatDMS_long(SGrid.postCenter.X);
        frmOverlayEditor.edtTablePosLat.Text := formatDMS_latt(SGrid.postCenter.Y);
        frmOverlayEditor.edtTableWidth.Text := FloatToStr(SGrid.Width);
        frmOverlayEditor.edtTableHeight.Text := FloatToStr(SGrid.Height);
        frmOverlayEditor.edtTableColumn.Text := IntToStr(SGrid.HCount);
        frmOverlayEditor.edtTableRow.Text  := IntToStr(SGrid.WCount);
        frmOverlayEditor.edtTableRotationAngle.Text := IntToStr(SGrid.Rotation);
        frmOverlayEditor.pnlOutline.color := SGrid.color;


        frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(SGrid.LineType);
        frmOverlayEditor.cbbWeightPen.Text := IntToStr(SGrid.weight);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmOverlayEditor.RefreshMousePointer;
          frmOverlayEditor.LoadPanelPolygon;

          frmOverlayEditor.lvPolyVertex.Clear;
          frmOverlayEditor.ShapeType := ovPolygon;
          ...
          begin
            ...
            with frmOverlayEditor.lvPolyVertex.Items.Add do
            begin
          ...
          frmOverlayEditor.lvPolyVertex.Items.BeginUpdate;
          try
           for k := 0 to frmOverlayEditor.lvPolyVertex.Items.Count-1 do
             frmOverlayEditor.lvPolyVertex.Items.Item[k].Caption:=IntToStr(k+1);
          finally
            frmOverlayEditor.lvPolyVertex.Items.EndUpdate;
          end;
          frmOverlayEditor.pnlOutline.color := SPolygon.color;

          frmOverlayEditor.cbbDashesPen.Text :=  lineTypeChoice(SPolygon.LineType);
          frmOverlayEditor.cbbWeightPen.Text := IntToStr(SPolygon.weight);
          ...
          begin
            frmOverlayEditor.SetNoFill(False);
            frmOverlayEditor.pnlFill.Color := SPolygon.ColorFill;
          end;
...
begin
  ...
  begin
    ...
    begin
      ...
      for a := 0 to frmOverlayEditor.lvPolyVertexD.Items.Count - 1 do
      begin
        li := frmOverlayEditor.lvPolyVertexD.Items[a];
    ...
    begin
      case ID of
        ...
        begin
          ...
          TextShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          TextShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
        ...
        begin
          ...
          LineShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          LineShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
        ...
        begin
          ...
          RectangleShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          RectangleShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
        ...
        begin
          ...
          CircleShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          CircleShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
        ...
        begin
          ...
          EllipseShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          EllipseShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
        ...
        begin
          ...
          ArcShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          ArcShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
        ...
        begin
          ...
          SectorShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          SectorShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
        ...
        begin
          ...
          GridShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          GridShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
        ...
        begin
          ...
          PolygonShape.ParentPos.X := frmOverlayEditor.Map1.CenterX;
          PolygonShape.ParentPos.Y := frmOverlayEditor.Map1.CenterY;
