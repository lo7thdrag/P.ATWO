...
type
  ...
  public
    ...
    constructor Create(Width, Height, valVelocity, X, Y: Integer; valHeading: Double; valForce: TColor);
    destructor Destroy; override;

    procedure DefinePolygon;
//    procedure Init(Width, Height, valVelocity, X, Y: Integer; valHeading: Double);
    procedure SetHeading(valHeading: Double);
...
constructor TMyShape.Create(Width, Height, valVelocity, X, Y: Integer; valHeading: Double; valForce: TColor);
begin
  inherited Create;
...
procedure TMyShape.SetHeading(valHeading: Double);
begin
  FHeading := valHeading;
  FTargetHeading := valHeading;
