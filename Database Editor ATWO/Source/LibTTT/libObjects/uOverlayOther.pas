    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            isSelected := true;
            frmOverlayEditor.edtRectStartPosLong.Text  := formatDM_longitude(rectanglePosStartLongitude);
            frmOverlayEditor.edtRectStartPosLat.Text   := formatDM_latitude(rectanglePosStartLatitude);
            frmOverlayEditor.edtRectEndPosLong.Text    := formatDM_longitude(rectanglePosEndLongitude);
            frmOverlayEditor.edtRectEndPosLat.Text     := formatDM_latitude(rectanglePosEndLatitude);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            isSelected := true;
            frmOverlayEditor.edtEllipsePosLong.Text  := formatDM_longitude(ellipsePosCenterLongitude);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            frmOverlayEditor.edtTextPosLong.Text  := formatDM_longitude(textPosStartLongitude);
            frmOverlayEditor.edtTextPosLAt.Text   := formatDM_latitude(textPosStartLatitude);
